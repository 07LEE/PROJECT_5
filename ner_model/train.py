...
from training.ner_tokenize import ner_tokenizer, encode_tags, TokenDataset
...
if __name__ == '__main__':
    ...
    # Load --------------------------------------------------
    with open('training/data/texts.pkl', 'rb') as f:
        texts = pickle.load(f)
    with open('training/data/tags.pkl', 'rb') as f:
        tags = pickle.load(f)
